...
public class PopularIterator {

    private final String TAG = getClass().getName();
    private IRecyclerFragmentPresenter presenter;


    public PopularIterator(IRecyclerFragmentPresenter presenter) {
        this.presenter = presenter;
    }

    public void getListPopularMovies(int page) {
        Retrofit retrofit = RestApiAdapter.provideRetrofit();


        retrofit.create(EndPoints.class).getPopularMovies(page)
